...
/**
 * ANSI — класс с статическим методом "modify", который принимает исходный текст и добавляет к нему ANSI-коды цвета и стиля, названия которых переданы в метод.
 */
public class ANSI {
...
/**
   * Модифицирует текст путём добавления ANSI-кодов цвета и стиля.
   ...
   */
  public static String modify(String text, String color, String style) {
